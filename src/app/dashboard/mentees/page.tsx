...
const MenteesPage = () => {
    ...
    useEffect(() => {
        if (user && connections.length > 0) {
            ...
            // Filter for mentees (juniors)
            const myMentees = myConnections.filter((u: any) => {
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-gray-500">Guide and support your juniors</p>
                        </div>
                    ...
                    {mentees.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {mentees.map((mentee) => (
                                <div key={mentee.email} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:shadow-md transition-shadow">
                                    ...
                                    <p className="text-sm text-gray-500 mb-1">{mentee.branch} • {mentee.year}</p>

                                    <div className="flex gap-2 mb-6 flex-wrap justify-center mt-2">
                                        {mentee.skills && mentee.skills.slice(0, 3).map((skill: string, idx: number) => (
                                    ...
                                    <Link
                                        ...
                                        className="w-full py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-xl font-medium flex items-center justify-center gap-2 transition-colors"
                                    >
                        ...
                        <div className="text-center py-16 bg-white rounded-3xl border border-gray-100">
                            ...
                            <p className="text-gray-500 max-w-md mx-auto mb-8">
                                You haven't connected with any juniors yet. Use the "Connect with Juniors" feature to start mentoring.
                            </p>
                        </div>
                    )}
                </div>
